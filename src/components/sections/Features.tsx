export default function Features() {
  ...
  return (
    <section id="features" className="bg-white" style={{ paddingTop: '100px', paddingBottom: '100px' }}>
      <div className="container-custom">
        <div className="text-center mb-24">
          <h2 className="text-5xl md:text-6xl font-bold mb-6 text-gray-900">Everything You Need to Build Better</h2>
          <p className="text-xl text-gray-600 mx-auto leading-relaxed text-center" style={{ paddingTop: '32px', paddingBottom: '32px' }}>
        ...
        <div className="rounded-2xl p-12 bg-gray-50" style={{ marginTop: '120px' }}>
          <h3 className="text-3xl font-bold mb-10 text-gray-900 text-center">Plus Many More</h3>
          
          {/* Features with descriptions */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
            <div className="bg-white rounded-xl p-6">
              <h4 className="text-xl font-bold text-gray-900 mb-3">Issues Tracking</h4>
              <p className="text-gray-600 leading-relaxed">Keep a complete record of every problem and fix—so nothing slips through and clients see you took action.</p>
            </div>
            <div className="bg-white rounded-xl p-6">
              <h4 className="text-xl font-bold text-gray-900 mb-3">Purchase Requests & Approvals</h4>
              <p className="text-gray-600 leading-relaxed">Control spending without micromanaging. Crew requests materials, you approve—full audit trail, no surprises.</p>
            </div>
          </div>
        </div>
      </div>
